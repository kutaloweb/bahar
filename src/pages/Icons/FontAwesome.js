...
class Icons extends Component {
    ...
    componentDidMount() {
        ...
        let brandIcons = '';
        solid.forEach(val => {
            solidIcons += '<div class="col-xl-3 col-lg-4 col-sm-6"> <i class="' + val + '"></i>' + val + '</div>';
        });
        regular.forEach(val => {
            regularIcons += '<div class="col-xl-3 col-lg-4 col-sm-6"> <i class="' + val + '"></i>' + val + '</div>';
        });
        brands.forEach(val => {
            brandIcons += '<div class="col-xl-3 col-lg-4 col-sm-6"> <i class="' + val + '"></i>' + val + '</div>';
        });
        document.getElementById("solid").innerHTML = solidIcons;
        document.getElementById("regular").innerHTML = regularIcons;
        document.getElementById("brand").innerHTML = brandIcons;
    }
            ...
            <React.Fragment>
                <div className="page-content">
                    <Container fluid>
                        ...
                        <Breadcrumbs title="Font awesome 5" breadcrumbItems={this.state.breadcrumbItems}/>
                            ...
                            <Col xs={12}>
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <Row className="icon-demo-content" id="regular">
                                        </Row>
                                    </CardBody>
                                </Card>
                                <Card>
                                    <CardBody>
                                        ...
                                        <Row className="icon-demo-content" id="brand">
                                        </Row>
                                    </CardBody>
                                </Card>
                            </Col>
